...
TEXT ·archMulF16(SB),NOSPLIT,$0-10
...
TEXT ·archMulF16s(SB),NOSPLIT,$0-72
...
main_loop:
    ...
    WORD $0x6e401c22 // VFADD V0.H8, V1.H8, V2.H8 -> fadd.8h v2, v1, v0
